...
function Modal(props) {
    var onOverlayClick = props.onOverlayClick, rest = __rest(props, ["onOverlayClick"]);
    function handleOverlayClick(event) {
        if (onOverlayClick && Overlay_1.isOverlay(event.target)) {
            onOverlayClick(event);
        }
    }
    return (react_1.default.createElement(Overlay_1.default, { fixed: true, onClick: handleOverlayClick },
...
var Window = styled_components_1.default(Column_1.default)(templateObject_2 || (templateObject_2 = __makeTemplateObject(["\n  align-self: center;\n  background-color: white;\n  margin-bottom: 10%;\n  margin-top: 10%;\n  max-width: 90%;\n  min-height: 50px;\n  min-width: 300px;\n"], ["\n  align-self: center;\n  background-color: white;\n  margin-bottom: 10%;\n  margin-top: 10%;\n  max-width: 90%;\n  min-height: 50px;\n  min-width: 300px;\n"])));
