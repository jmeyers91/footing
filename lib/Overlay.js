...
function Overlay(props) {
    var fixed = props.fixed, color = props.color, fixedRoot = props.fixedRoot, rest = __rest(props, ["fixed", "color", "fixedRoot"]);
    if (fixed) {
        return react_dom_1.default.createPortal(react_1.default.createElement(Column_1.default, __assign({}, rest, { "data-overlay": true })), fixedRoot || document.body);
    }
    else {
